...
abstract class _$BuildDatabase extends GeneratedDatabase {
  _$BuildDatabase(QueryExecutor e) : super(e);
  $BuildDatabaseManager get managers => $BuildDatabaseManager(this);
...
class $$QuotesTableFilterComposer
    extends Composer<_$BuildDatabase, $QuotesTable> {
...
class $$QuotesTableTableManager extends RootTableManager<
    ...
    (QuoteData, BaseReferences<_$BuildDatabase, $QuotesTable, QuoteData>),
    QuoteData,
    PrefetchHooks Function()> {
  $$QuotesTableTableManager(_$BuildDatabase db, $QuotesTable table)
...
class $$EpisodesTableFilterComposer
    extends Composer<_$BuildDatabase, $EpisodesTable> {
...
class $$EpisodesTableTableManager extends RootTableManager<
    ...
    (EpisodeData, BaseReferences<_$BuildDatabase, $EpisodesTable, EpisodeData>),
    EpisodeData,
    PrefetchHooks Function()> {
  $$EpisodesTableTableManager(_$BuildDatabase db, $EpisodesTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
...
class $$ReferencesTableFilterComposer
    extends Composer<_$BuildDatabase, $ReferencesTable> {
...
class $$ReferencesTableTableManager extends RootTableManager<
    ...
    (
      ReferenceData,
      BaseReferences<_$BuildDatabase, $ReferencesTable, ReferenceData>
    ),
    ReferenceData,
    PrefetchHooks Function()> {
  $$ReferencesTableTableManager(_$BuildDatabase db, $ReferencesTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
...
class $BuildDatabaseManager {
  final _$BuildDatabase _db;
  $BuildDatabaseManager(this._db);
